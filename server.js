...
let connectionString = 'mongodb+srv://ToDo-App:todoapp123@cluster0-xzbyb.mongodb.net/ToDo-App?retryWrites=true&w=majority';
    ...
    db.collection('items').find().toArray((err, items)=>{
        ...
        <body>
          <div class="container">
            ...
            <ul id="item-lists" class="list-group pb-5">
