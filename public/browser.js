...
document.getElementById('item-lists').insertAdjacentHTML('beforeend', ourHTML)
...
document.getElementById('create-form').addEventListener('submit', (e)=>{
    ...
    axios.post('/create-item', {text: createField.value}).then((response)=>{
      document.getElementById('item-lists').insertAdjacentHTML('beforeend', itemTemplete(response.data));
      createField.value = '';
      createField.focus();
    }).catch(()=>{
